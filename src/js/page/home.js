...
import { TortaChart } from "../components/simpelTortaChart.jsx";
...
const Home = () => {
    ...
    return (
        <div className="ps-3 overflow-auto contenedor">
            ...
            <div className="container d-flex p-3 justify-content-center border border-2 border-info pt-5" style={{ borderRadius: "10px", height:"50vh"}}>
                    <TortaChart className=""/>
                <div className="row ms-3 text-secondary fw-bold"><h1>Estado de los Equipos</h1></div>
            </div>:
            <>
            ...
            <div className="d-flex justify-content-center mx-auto" style={{ maxHeight: "50vh", maxWidth: "85vw" }}>
                ...
                <div className="row-sm col border border-2 border-info d-flex justify-content-center p-5" style={{ borderRadius: "10px" }}>
                    <PieExample />
                </div>
                <div className="row-sm col border border-2 border-info pt-5 ms-2" style={{ borderRadius: "10px" }}>
                    <Torta className="row" />
