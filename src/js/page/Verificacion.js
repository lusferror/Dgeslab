...
const Verificacion = ()=>{
  ...
  <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
    <div class="col">
      <div><h1 class="">Verificación</h1></div>
    </div>
       <div class="btn-group " role="group" aria-label="Basic example">
  <button type="button " class="border border-dark btn btn-primary">Seleccionar Todo</button>
...
<td>Celda de tabla</td>
                ...
                <td><input class="form-control" type="text" placeholder="Pendiente" aria-label="Disabled input example" disabled/></td>
