          ...
          <tbody>
            {
              store.listaAsignacionFinal.map((item, index) => {
                return (<tr>
                  ...
                  <td className=""><form name="f1" id="formElement"><input type="checkbox" name="ch1" value={item.check} onClick={()=>actions.check(index)}/> </form></td>:
                  <td className=""><form name="f1" id="formElement"><input type="checkbox" name="ch1" value={item.check} onClick={()=>actions.check(index)} disabled/> </form></td>}
